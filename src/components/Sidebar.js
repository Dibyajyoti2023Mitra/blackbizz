                        ...
                        <List>
                            {
                                navItems.map(({ text, icon }) => {
                                    ...
                                    return <ListItem key={text} disablePadding>
                                        <ListItemButton
                                            sx={{
                                                backgroundColor: active === lctext.split(" ").join("") ?
                                                    theme.palette.secondary[300]
                                                    : "transparent",
                                                color: active === lctext.split(" ").join("") ?
                                                    theme.palette.primary[600]
                                                    : theme.palette.secondary[100],
                                            }}
                                            onClick={() => {
                                                navigate(`/${lctext.split(" ").join("")}`);
                                                setActive(lctext.split(" ").join(""))
                                            }}>
                                            <ListItemIcon
                                                sx={{
                                                    ml: "2rem",
                                                    color: active === lctext.split(" ").join("") ? theme.palette.primary[600]
